...
<html lang="es">
	...
	<body onload="initialize()">
			...
			<ul class="nav navbar-nav">
				 ...
				 <li><a	class="pointer unselectable" id="btn2" onmouseup="changeFrame(this);" style="color: white;"><span style="font-size: 12pt;" class="glyphicon glyphicon-cog"></span> Configuración</a></li>
				 ...
				 <li><a	class="pointer unselectable" id="btnDigitacionUroanalisis" onmouseup="changeFrame(this);" style="color: white;"><span style="font-size: 12pt;" class="glyphicon glyphicon-object-align-horizontal"></span> QAP-FOR-07 Uroanálisis</a></li>
				 ...
				 <li><a	class="pointer unselectable" id="btn3" onmouseup="changeFrame(this);" style="color: white;"><span style="font-size: 12pt;" class="glyphicon glyphicon-log-out"></span> Cerrar sesión</a></li>						 
			</ul>
			...
			<?php 
				switch($_SESSION["qap_key"]){
					case 0: // Si es administrador total
			?>
						<a class="navbar-brand navbar-right" href="index_a.php" style="margin-right: 0px; color: white;">QAP Online v<?php echo $val_1; ?> | <span style='color:#ccc; font-size: 1.5rem; text-shadow: 0px 0px 1px #fff'>Administración</span></a>
			<?php
						break;
					case 100: // Si es coordinador QAP Online
			?>
						<a class="navbar-brand navbar-right" href="index_a.php" style="margin-right: 0px; color: white;">QAP Online v<?php echo $val_1; ?> | <span style='color:#ccc; font-size: 1.5rem; text-shadow: 0px 0px 1px #fff'>Coordinación</span></a>
			<?php
						break;
					case 102: // Si es Generador de informes
			?>
