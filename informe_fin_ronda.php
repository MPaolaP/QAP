	...
	<body>
		<div class="col-xs-12 no-margin no-padding">
			<div class="col-xs-2" style="height: 100vh; overflow: auto;">
				...
				<div class="col-xs-12 margin-top-6 no-padding" id="formReporteFinRonda">
					<div class="form-group">
						<label for="laboratorio_fin_ronda">Laboratorio</label>
						<select class="form-control input-sm" id="laboratorio_fin_ronda" name="laboratorio_fin_ronda">
						<?php
							$qry = "SELECT id_laboratorio,no_laboratorio,nombre_laboratorio FROM $tbl_laboratorio where no_laboratorio like '100%' ORDER BY no_laboratorio ASC";
					...
					<div class="form-group">
						<label for="programa_fin_ronda">Programa</label>
						<select class="form-control input-sm" id="programa_fin_ronda" name="programa_fin_ronda"></select>
					</div>
					<div class="form-group">
						<label for="ronda_fin_ronda">Ronda</label>
						<select class="form-control input-sm" id="ronda_fin_ronda" name="ronda_fin_ronda"></select>
					</div>
					<div id="fechas_corte">
		...
		<script src="javascript/informe_fin_ronda.js?v12"></script>
