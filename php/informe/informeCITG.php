    ...
    while($qryData = mysql_fetch_array($qryArray)) {
        ...
        while($qryDataPregunta = mysql_fetch_array($qryArrayPregunta)) {
            ...
            while($qryDataDistractorIntento = mysql_fetch_array($qryArrayDistractorIntento)) {
                ...
                $valor_distractor = $qryDataDistractorIntento["valor"];
            }
            ...
            } else if($valor_distractor == 5) {
                $pdf->SetFillColor(244, 208, 63); // Amarillo pero concordante
                $pdf->Cell(160,5,"Discordancia menor",1,0,'C',1);
            } else {
