<?php
    ...
    while($qryData = mysql_fetch_array($qryArray)) {
        ...
        */
        ...
        $pdf->Row_dos($ArrayDiscriminado[0]); // Distractor
        // $pdf->Row_dos($ArrayDiscriminado[1]); // Numero y porcentaje
    ...
    // $pdf->Cell(40,4,"COD.\nPatólogo",1,0,'C',1);
    // $pdf->Cell(33.5,4,"Concordantes",1,0,'C',1);
    // $pdf->Cell(33.5,4,"No concordantes",1,0,'C',1);
    ...
    //     $pdf->Cell(40,4,$usuarios_pat[$count_pat]["cod_usuario"],1,0,'C',1);

    //     $pdf->SetFont("Arial","",6);
    //     $pdf->Cell(33.5,4,$usuarios_pat[$count_pat]["concordantes"],1,0,'C',1);
    //     $pdf->Cell(33.5,4,$usuarios_pat[$count_pat]["no_concordantes"],1,0,'C',1);
    // }
    ...
    // $pdf->Cell(40,4,"Total",1,0,'C',1);

    // $pdf->SetFont("Arial","",6);
    // $pdf->Cell(33.5,4,$pdf->contarNumsArray(array_column($usuarios_pat,"concordantes")),1,0,'C',1);
    // $pdf->Cell(33.5,4,$pdf->contarNumsArray(array_column($usuarios_pat,"no_concordantes")),1,0,'C',1);
    ...
    // Cerrar PDF
    $pdf->Close();
    $nomArchivo = utf8_decode("$num_laboratorio - Intralaboratorio PQ $pdf->nom_reto $nom_laboratorio.pdf");
