...
class Grubbs
{
    ...
    public function exclusionAtipicos($array_resultados, $columna, $retornar_solo_atipicos = false)
    {
        ...
        if (sizeof($this->resultados) > 2) {
            ...
            foreach ($array_resultados as $row_result) {
                ...
                //     if ($row_result[$columna] <= $this->limite_inf || $row_result[$columna] >= $this->limite_sup) { // Si esta fuera los limites
                ...
                //     if ($row_result[$columna] > $this->limite_inf && $row_result[$columna] < $this->limite_sup) { // Si esta entre los limites
    ...
    public function get_factor_grubbs_utilizado()
    {
        ...
        if (isset($this->factor_grubbs_utilizado)) {
            ...
            return round($this->factor_grubbs_utilizado, 3);
    ...
    public function get_limite_inf()
    {
        ...
        if (isset($this->limite_inf)) {
            ...
            return round($this->limite_inf, 3);
    ...
    public function get_limite_sup()
    {
        ...
        if (isset($this->limite_sup)) {
            ...
            return round($this->limite_sup, 3);
