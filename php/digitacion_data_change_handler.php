                    ...
                    for($count=0; $count<sizeof($data_ajax->obj_json_save); $count++){
                        ...
                        if($analito_digitacion != '0' && $m_wwr != '0'){ // Si los analitos se han especificado con los valores de cambio en los selects
                            ...
                            if(!isset($id_media_analito) || $id_media_analito == null){                                        
                                $qry = "INSERT INTO media_evaluacion_caso_especial(id_configuracion, media_estandar, desviacion_estandar, coeficiente_variacion, n_evaluacion, id_muestra, nivel, id_laboratorio, id_digitacion_wwr, tipo_digitacion_wwr) 
                                    VALUES('$id_configuracion_pa', '$media_ce', '$de_ce', '$cv_ce', '$n_ce', '$id_muestra_av', '$nivel_lote_av', '$id_laboratorio_av', $analito_digitacion, '$m_wwr')";
                                mysql_query($qry);
                                ...
                                $qry = "UPDATE media_evaluacion_caso_especial 
                                    SET media_estandar='$media_ce', desviacion_estandar='$de_ce', coeficiente_variacion='$cv_ce', n_evaluacion = '$n_ce',  id_digitacion_wwr = $analito_digitacion, tipo_digitacion_wwr = '$m_wwr'
